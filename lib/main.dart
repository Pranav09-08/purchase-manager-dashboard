...
// ================= VENDOR =================
import 'vendor/analytics/vendor_analytics.dart';
import 'vendor/components/vendor_components.dart';
import 'vendor/profile/vendor_profile.dart';
import 'vendor/overview/vendor_overview.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        //================= ADMIN =================
        '/adminDashboard': (_) => const AdminAuthGuard(child: AdminDashboardScreen(),),
        '/listPlanningManager': (_) => const AdminAuthGuard(child: PlanningManagerListScreen(),),
        '/createPlanningManager': (_) => const AdminAuthGuard(child: PlanningManagerCreateScreen(),),
        '/salesManagers': (_) => const AdminAuthGuard(child: SalesManagerListScreen(),),
        '/createSalesManager': (_) => const AdminAuthGuard(child: SalesManagerCreateScreen(),),
        '/clients': (_) => const AdminAuthGuard(child: AdminClientListScreen(),),
        '/createClient': (_) => const AdminAuthGuard(child: ClientCreateScreen(),),
        '/companyProfile': (_) => const AdminAuthGuard(child: CompanyProfileScreen(),),
        '/products': (_) => const AdminAuthGuard(child: ProductListScreen(),),
        '/createProduct': (_) => const AdminAuthGuard(child: ProductCreateScreen(),),
        ...
        // ================= PLANNING MANAGER =================
        '/planning_manager/products': (_) => const PlanningProductListScreen(),
        '/planning_manager/profile': (_) => const PlanningManagerProfileScreen(),
        '/planning_manager/createWorkOrders': (_) => const WorkOrdersScreen(),
        '/planning_manager/listWorkOrders': (_) => const ListWorkOrdersScreen(),

        // ================= PLANNING MANAGER =================
        '/VendorOverview': (_) => const VendorOverview(),
        '/vendorAnalytics': (_) => const VendorAnalysisScreen(),
        '/vendorProfile': (_) => const VendorProfileScreen(),
        '/vendorComponents': (_) => const VendorComponentsScreen(),
