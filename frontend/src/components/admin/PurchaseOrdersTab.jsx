...
function PurchaseOrdersTab({ orders, vendorLookup = {}, onGoToInvoices, focusLoiId, onClearFocus }) {
  ...
  const getNextStep = (status) => {
    if (status === 'pending') return 'Waiting for vendor confirmation.';
    if (status === 'confirmed') return 'Initiate payment.';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-slate-500">Track vendor confirmations and delivery status.</p>
      </div>
