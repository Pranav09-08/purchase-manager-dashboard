...
function VendorInvoicesTab({ invoices, payments = [], vendorLookup = {}, componentLookup = {}, orderLookup = {}, onMarkReceived, onAccept, onReject, onMarkPaid, onGoToPayments, focusOrderId, onClearFocus }) {
  ...
  const getNextStep = (status) => {
    ...
    if (status === 'accepted') return 'Mark paid after settlement.';
    if (status === 'paid') return 'Invoice closed.';
              ...
              >
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-slate-500 mt-1">{getNextStep(invoice.status)}</p>
                  </div>
