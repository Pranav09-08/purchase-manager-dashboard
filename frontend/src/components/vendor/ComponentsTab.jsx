              ...
              {components.map((component) => (
                <div key={component.componentid} className="data-card relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className={`inline-block px-2 py-1 rounded text-xs font-semibold ${getStatusColor(component.status)}`}>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <button
                      onClick={() => onDeleteComponent(component.componentid)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
            ...
            <div className="p-6 border-t border-slate-200 flex justify-end gap-3">
              ...
              {selectedComponent.status === 'rejected' && (
                <button
                  onClick={() => {
                ...
                >
                  {loading ? 'Processing...' : 'Edit Component'}
                </button>
              )}
